...
/**
 * @name AtlanticAccount
 * @description AtlanticAccount Model
 */
class AtlanticAccount extends ActiveRecord
{
    /**
     * @database
     * @readwrite
     ...
     * @readwrite
     */
    protected $_table = 'atlantic_accounts';
    ...
    public function delete() : int
    {
        ...
        DigitalOceanDroplet::deleteWhere('account_id = ? ',[$this->_id]);
