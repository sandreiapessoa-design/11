...
/**
 * @name AtlanticInstance
 * @description AtlanticInstance Model
 */
class AtlanticInstance extends ActiveRecord
{
     ...
     * @readwrite
     */
    protected $_table = 'atlantic_instances';
