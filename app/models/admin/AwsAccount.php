...
/**
 * @name AwsAccount
 * @description AwsAccount Model
 */
class AwsAccount extends ActiveRecord
{
    /**
     * @database
     * @readwrite
    ...
    public function delete() : int
    {
        ...
        AwsInstance::deleteWhere('account_id = ? ',[$this->_id]);
