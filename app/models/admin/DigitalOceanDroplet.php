 ...
 * @description DigitalOceanDroplet Model
 */
class DigitalOceanDroplet extends ActiveRecord
{
    /**
     * @database
     * @readwrite
     ...
     * @readwrite
     */
    protected $_table = 'digital_ocean_droplets';
