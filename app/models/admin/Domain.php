...
class Domain extends ActiveRecord
{
    ...
    public function insert() : int
    {
        ...
        # register audit log
        AuditLog::registerLog($this->_id,$this->_value,Objects::getInstance()->getName($this),'Insert');
    ...
    {
        # register audit log
        AuditLog::registerLog($this->_id,$this->_value,Objects::getInstance()->getName($this),'Update');
    ...
    {
        # register audit log
        AuditLog::registerLog($this->_id,$this->_value,Objects::getInstance()->getName($this),'Delete');
