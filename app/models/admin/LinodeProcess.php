...
/**
 * @name LinodeProcess
 * @description LinodeProcess Model
 */
class LinodeProcess extends ActiveRecord
{
    /**
     * @database
     * @readwrite
     ...
     * @readwrite
     */
    protected $_table = 'linode_processes';
    ...
    public function insert() : int
    {
        ...
        # register audit log
        AuditLog::registerLog($this->_id,'Linode Process','Instances Creation','Start');
    ...
    {
        # register audit log
        AuditLog::registerLog($this->_id,'Linode Process','Instances Termination','Start');
