...
/**
 * @name MtaServer
 * @description MtaServer Model
 */
class MtaServer extends ActiveRecord
{
    /**
     * @database
     * @readwrite
     ...
     * @length 100
     */
    protected $_ssh_connectivity_status;
    ...
    public function delete() : int
    {
        ...
        Application::getCurrent()->database("system")->execute("UPDATE admin.domains SET ip_id = 0 , availability = 'Available' WHERE mta_server_id = {$this->_id}");

        # delete server vmtas if any
        ServerVmta::deleteWhere('mta_server_id = ?',[$this->_id]);
