...
/**
 * @name Namecheap
 * @description Namecheap Model
 */
class Namecheap extends ActiveRecord
{
    /**
     * @database
     * @readwrite
     ...
     * @readwrite
     */
    protected $_table = 'namecheap_accounts';
    ...
    public function delete() : int
    {
        ...
        Domain::deleteWhere('account_id = ? AND account_type = ?',[$this->_id,'namecheap']);
