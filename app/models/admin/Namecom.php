...
/**
 * @name Namecom
 * @description Namecom Model
 */
class Namecom extends ActiveRecord
{
    /**
     * @database
     * @readwrite
     ...
     * @readwrite
     */
    protected $_table = 'namecom_accounts';
    ...
    public function delete() : int
    {
        ...
        Domain::deleteWhere('account_id = ? AND account_type = ?',[$this->_id,'namecom']);
