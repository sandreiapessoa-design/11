...
/**
 * @name ScalewayAccount
 * @description ScalewayAccount Model
 */
class ScalewayAccount extends ActiveRecord
{
    /**
     * @database
     * @readwrite
     ...
     * @readwrite
     */
    protected $_table = 'scaleway_accounts';
