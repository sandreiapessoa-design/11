...
class Vultr extends Base
{
    ...
    { 
        ...
        $access = Permissions::checkForAuthorization(Authentication::getAuthenticatedUser(),'VultrInstances','create');
        ...
        $account = VultrAccount::first(VultrAccount::FETCH_ARRAY,['id = ?',intval($this->app->utils->arrays->get($parameters,'account-id',0))],['id']);
        ...
        # call iresponse api
        Api::call('Vultr','createInstances',['process-id' => $process->insert()],true,LOGS_PATH . DS . 'cloud_apis' . DS . 'inst_vultr_' . $account['id'] . '.log');
    ...
    { 
        ...
        # call iresponse api
        $result = Api::call('Vultr','stopProcesses',['processes-ids' => $processesIds]);
    ...
    { 
        ...
        # check for permissions
        $access = Permissions::checkForAuthorization(Authentication::getAuthenticatedUser(),'VultrInstances','main');
        ...
        # call iresponse api
        $result = Api::call('Vultr','executeInstancesActions',['instances-ids' => $instancesIds,'action' => $action]);
